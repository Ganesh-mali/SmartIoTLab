      ...
      <form id="myForm" class="form-horizontal" method="post" name="stuform" onsubmit="return(validate());">
        <fieldset>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label" for="studentname">Student Name</label>
            <div class="col-sm-9">
          ...
          <!-- Text input-->
          <div class="form-group">
            <label class="col-sm-3 control-label" for="studentrn">Student Roll No</label>
            <div class="col-sm-9">
              <input type="text" name="studentrn" class="form-control" required>
							<div class="form-group has-error">
          ...
          <!-- Text input-->
          <div class="form-group">
            <label class="col-sm-3 control-label" for="mobilen">Student Mobile No</label>
            <div class="col-sm-9">
              <input type="text" name="mobilen" class="form-control" required>
							<div class="form-group has-error">
							<span id="helpBlock3" class="help-block"></span>
							</div>
            </div>
          ...
          <!-- Text input-->
          <div class="form-group">
            <label class="col-sm-3 control-label" for="studentba">Student Batch</label>
            <div class="col-sm-9">
              <select name="studentba">
          ...
          <!-- Text input-->
          <div class="form-group">
            <label class="col-sm-3 control-label" for="studentbr">Student Branch</label>
            <div class="col-sm-9">
              <select name="studentbr">
          ...
          <!-- Text input-->
          <div class="form-group">
            <label class="col-sm-3 control-label" for="studentd">Degree</label>
            <div class="col-sm-9">
              <select name="studentd">
          ...
          <!-- Text input-->
          <div class="form-group">
            <label class="col-sm-3 control-label" for="comdrop">Component Name</label>
