...
void setup() {
    ...
    radio.openWritingPipe(0x65646f4e32);//Working with Node RED address 0x65646f4e31 //originally slave address
...
//        String dataToSend = "{PIR:" + data_PIR ;
//        dataToSend+= " LDR"+data_LDR;
//        dataToSend+= "}";
