...
# =============================================================================
    for tval in range(35,36):
        ...
        for i in range(0,175):
            img1 = cv2.imread("E:\\SmartIoTLab\\Images\\Dataset\\Dataset2\\"+str(i)+".jpeg",0)
            img2 = cv2.imread("E:\\SmartIoTLab\\Images\\Dataset\\Dataset2\\"+str(i+1)+".jpeg",0)
            ...
            _,thresh1 = cv2.threshold(diff,tval,255,cv2.THRESH_BINARY)
